...
abstract class Model
{
    ...
    public  function errorMessages(){
        return [
            ...
            self::RULE_EMAIL => 'email {email}',
            self::RULE_MIN => 'too small {min}',
            self::RULE_MAX => 'too big {max}',
            self::RULE_MATCH => 'pls match {match} пидар ',
            self::RULE_UNIQUE => '{field} already in use lol ',
